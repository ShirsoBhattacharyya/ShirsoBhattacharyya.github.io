...
const Skills = () => {
  return (
    <Box id="skills">
      <h1 style={{ textAlign: "center", padding: "4rem 0", fontSize: "38px" }}>
        SKILLS :
      </h1>
      <Box>
        <Box className={Styles.skillsets}>
          <h1
            style={{ fontSize: "2rem", textAlign: "center", padding: "2rem 0" }}
          >
            Frontend
          </h1>
          <Box
          ...
          <h1
            style={{ fontSize: "2rem", textAlign: "center", padding: "4rem 0" }}
          >
            Backend
          </h1>
          <Box
        ...
        <Box position="relative">
          ...
          <Box display="flex" justifyContent="center" m="2rem">
            <img
              src="https://github-readme-streak-stats.herokuapp.com/?user=ShirsoBhattacharyya&theme=dark&hide_border=false&include_all_commits=true&count_private=true"
              alt=""
            />
          </Box>
        </Box>
